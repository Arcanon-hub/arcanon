...
- [ ] 131-03-PLAN.md — Cross-AI review gap-closure: actor-edge protocol_raw end-to-end (migration 020 + writer/read/detail) + k8s/tf/helm/import renderable (no silent drop) + full-CANONICAL_PROTOCOLS drift test + checkbox-coverage + diff casing + explicit-other warning + narrowed catches
